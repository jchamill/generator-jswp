...
module.exports = class extends Generator {
  ...
  writing() {
    ...
    this.fs.copy(
      this.templatePath('sass/widgets/hero.sass'),
      this.destinationPath('sass/widgets/hero.sass')
    );
    ...
    this.fs.copy(
      this.templatePath('sass/widgets/people.sass'),
      this.destinationPath('sass/widgets/people.sass')
    );
    ...
    this.fs.copy(
      this.templatePath('sass/widgets/logos.sass'),
      this.destinationPath('sass/widgets/logos.sass')
    );
    ...
    this.fs.copy(
      this.templatePath('sass/widgets/cards.sass'),
      this.destinationPath('sass/widgets/cards.sass')
    );
    ...
    this.fs.copy(
      this.templatePath('js/widgets/hero.js'),
      this.destinationPath('js/widgets/hero.js')
    );
